...
| **R** | 4.x | Statistical modeling and visualization | Merged ARG matrices | Publication figures (PDF/PNG) |
| **R Packages** | (various) | ggplot2, dplyr, vegan, pheatmap, FactoMineR | Dataframes | Plots / Statistics |
